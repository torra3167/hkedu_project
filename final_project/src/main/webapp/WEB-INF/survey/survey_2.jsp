    ...
    <div class="container mt-3">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <form:textarea path="survDisease" rows="5" cols="50" placeholder="당뇨, 갑상선 질환 등 운동과 식단을 계획하는 데 고려해야 할 질환이 있다면 여기에 작성해주세요."></form:textarea>
        </div>
        <div class="form-group">
          <label>다이어트를 하는 데 가장 큰 걱정</label><br>
          <form:textarea path="survConcern" rows="5" cols="50" placeholder="불규칙한 식습관, 수면습관 등 다이어트를 하는 데 걱정이 있다면 여기에 작성해주세요."></form:textarea>
        </div>
        <div class="form-group">
          <label>지난 다이어트 실패 원인</label><br>
          <form:textarea path="survCause" rows="5" cols="50" placeholder="자신이 생각하는 지난 다이어트의 실패 원인을 여기에 작성해주세요."></form:textarea>
        </div>
        <div class="form-group">
          <label>과거 운동 경력</label><br>
          <form:textarea path="survCareer" rows="5" cols="50" placeholder="과거에 해본 운동이 있으면 여기에 작성해주세요."></form:textarea>
        </div>
        <div class="form-group">
