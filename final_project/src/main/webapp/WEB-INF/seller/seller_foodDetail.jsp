...
<div class="container mt-3" style="max-width: 560px;">
			...
			<div class="form-group">
				<label>식품 판매가격(원)</label> <input type="text" name="foodPrice" class="form-control" value="" readonly="true">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label>판매할 식품 개수</label> <input type="text" name="foodQuant" class="form-control" value="" readonly="true">
			</div>
			<div class="form-group">
				<label>식품 유통기한</label> <input type="text" name="foodExpiryDate" class="form-control" value="" readonly="true">
			</div>
			<div class="form-group">
				<label>식품재료 원산지</label> <input type="text" name="foodOrigin" class="form-control" value="" readonly="true">
			</div>
			<div class="form-group">
				<label>식품 탄수화물 함량(g)</label> <input type="text" name="foodCarbo" class="form-control" value="" readonly="true">
			</div>
			<div class="form-group">
				<label>식품 단백질 함량(g)</label> <input type="text" name="foodProtein" class="form-control" value="" readonly="true">
			</div>
			<div class="form-group">
				<label>식품 지방 함량(g)</label> <input type="text" name="foodFat" class="form-control" value="" readonly="true">
			</div>
			<div class="form-group">
				<label>식품 칼로리(kcal)</label> <input type="text" name="foodCal" class="form-control" value="" readonly="true">
			</div>
