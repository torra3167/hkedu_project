...
public class SellerController {
		...
		public String sellerApplicationSubmit(SellerApplicationWriteCommand sellerApplicationWriteCommand, HttpSession session, Model model) { 
			sellerService.insertSellerApplication(sellerApplicationWriteCommand, session, model);
			return "index";
		}
		...
		public String sellerApplicationList(Model model) {
			...
			sellerService.selectSellerApplicationList(model);
...
//			sellerService.selectSellerApplication((String)session.getAttribute("email"), model);
